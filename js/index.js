...
//          centeredSlidesBounds: true,
		...
		var swiper = new Swiper('.detail-mobile_swiper .swiper-container', {
			autoplay: true,
		  slidesPerView: 1,
		  spaceBetween: 0,
		  loop: true,
		  pagination: {
			el: '.detail-mobile_swiper .swiper-pagination',
			clickable: true,
		  },
		  navigation: {
			nextEl: '.detail-mobile_swiper .swiper-button-next',
			prevEl: '.detail-mobile_swiper .swiper-button-prev',
		  },
		});
